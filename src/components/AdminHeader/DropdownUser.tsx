      ...
      >
        <span className="h-12 w-12 rounded-full">
          <Image
            width={112}
            height={112}
            src="/images/testimonials/noimage.jpg"
            style={{
              width: "auto",
              height: "auto",
            }}
        ...
        <span className="flex items-center gap-2 font-medium text-gray-700 dark:text-white">
          <span className="hidden lg:block">Praveen Singh Thakur</span>
        ...
        >
          <div className="flex items-center gap-2.5 px-5 pb-5.5 pt-3.5">
            ...
            <span className="block">
              <span className="block font-medium text-gray-700 dark:text-white">
          ...
          <div className="p-2.5">
            <button className="flex w-full items-center gap-2.5 rounded-[7px] p-2.5 text-sm font-medium text-gray-700 duration-300 ease-in-out hover:bg-gray-2 hover:text-dark dark:text-white dark:hover:bg-dark-3 dark:hover:text-gray-500 lg:text-base">
              <svg
