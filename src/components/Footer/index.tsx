    ...
    <>
      <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
        <div className="container">
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    ...
                    alt="logo"
                    className=" dark:hidden object-cover object-center w-40 h-40"
                    width={100}
                    height={20}
                  />
                  <Image
                    src="/images/logo/as_logo.png"
                    alt="logo"
                    className="hidden dark:block object-cover object-center w-40 h-40"
                    width={100}
                    height={20}
                  />
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.instagram.com/apnasadhan"
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=61559018083173"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  ...
                  <a
                    href="https://www.youtube.com/@apnasadhan"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  ...
                  <a
                    href="https://www.linkedin.com/apnasadhan"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">Copyright © {new Date().getFullYear()} ApnaSadhan. All rights reserved.</p>
          </div>
        </div>
