        ...
        <div className="container flex flex-wrap">
          <div className="w-full md:w-1/2 px-4">
            <div className="mx-auto max-w-[800px] text-center md:text-left flex justify-center items-center md:items-start flex-col">
              ...
              <div className="typewriter-container mt-6 p-4 rounded-lg bg-gradient-to-r from-[#092f98] to-[#06ab0b] shadow-lg text-lg md:text-xl font-medium bg-gradient-to-r from-blue-700 to-green-600 dark:from-blue-600 dark:to-green-600 bg-clip-text text-transparent min-h-36 md:min-h-24 flex items-center justify-center">
                <Typewriter
                  words={[
