    ...
    menuItems: [
      {
        ...
        label: "Dashboard",
        route: "/management/secure-gateway/4f3d5b6e-12c8-11e9-ab14-d663bd873d93/dashboard",
        children: [
      ...
      },
      {
        ...
        label: "Bookings",
        route: "/management/secure-gateway/4f3d5b6e-12c8-11e9-ab14-d663bd873d93/bookings"
      },
      {
        icon: <FaSuitcase className="text-xl" />,
        label: "Tour Packages",
        route: "/management/secure-gateway/4f3d5b6e-12c8-11e9-ab14-d663bd873d93/tour-packages"
      },
      {
        icon: <FaCar className="text-xl" />,
        label: "Our Cars",
        route: "/management/secure-gateway/4f3d5b6e-12c8-11e9-ab14-d663bd873d93/our-cars"
      },
      {
